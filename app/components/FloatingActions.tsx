  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-3">
      ...
      <button
        ...
        className={`flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-dark shadow-lg transition-all duration-400 hover:bg-carbon hover:text-white hover:border-carbon hover:shadow-xl ${
          showTop
